...
|20250521
|annotated assembly modifiers and range checking rules for some relocations;
typo fix.

|20251210
|added 13 new relocation types (numbers 127 through 139) applicable to 32-bit
LoongArch; annotated TLS relocations.
|====
...
|69
|R_LARCH_ABS64_LO20
|[51 ... 32] bits of 64-bit absolute address, `%abs64_lo20(symbol)`
...
|[51 ... 32] bits of 64-bit PC-relative offset, `%pc64_lo20(symbol)`
...
|81
|R_LARCH_GOT64_LO20
|[51 ... 32] bits of 64-bit GOT entry absolute address, `%got64_lo20(symbol)`
...
|[51 ... 32] bits of TLS LE 64-bit offset from TP register, `%le64_lo20(symbol)`
...
|[51 ... 32] bits of 64-bit PC-relative offset to TLS IE GOT entry, `%ie64_pc_lo20(symbol)`
...
|[51 ... 32] bits of 64-bit TLS IE GOT entry absolute address, `%ie64_lo20(symbol)`
...
|110
|R_LARCH_CALL36
|Used for medium code model function call sequence `pcaddu18i + jirl`, `%call36(symbol)`. The two instructions must be adjacent.
...
|[51 ... 32] bits of 64-bit PC-relative offset to TLS DESC GOT entry, `%desc64_pc_lo20(symbol)`
...
|[51 ... 32] bits of 64-bit TLS DESC GOT entry absolute address, `%desc64_lo20(symbol)`
...
adjacent so that the linker can infer the PC of `pcalau12i` to apply
